    ...
    <div className="">
      <nav className="p-4 flex h-20 items-center text-lg bg-[#2c2c2c] text-white shadow-2xl ">
        ...
        <div className="px-8 py-4">
          <Link to="/" className="ml-4 hover:text-blue-400 text-xl">
            Home
          </Link>
          <Link to="/todo" className="ml-4 hover:text-blue-400 text-xl">
            Todo
          </Link>
        </div>
        <div className="ml-auto mr-4 px-8 py-4">
          {user ? (
            <div>
              ...
              <button
                onClick={logout}
                className="ml-4 border rounded-4xl py-1 px-4  hover:text-blue-400"
              >
                Logout
              </button>
            </div>
